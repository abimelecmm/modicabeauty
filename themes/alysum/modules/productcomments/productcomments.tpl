...
<section data-section="10">
	...
	{if (!$too_early AND ($logged OR $allow_guests))}
		<a id="new_comment_tab_btn" class="button open-comment-form" href="#new_comment_form">{l s='Write your review' mod='productcomments'} !</a>
    {/if}
	{if $comments}
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p class="fr">
						...
						<!--<button id="submitNewMessage" class="button" name="submitMessage" type="submit">{l s='Send' mod='productcomments'}</button>-->&nbsp;
						<a href="#" class="button" onclick="$.fancybox.close();">{l s='Cancel' mod='productcomments'}</a>
					</p>
					<div class="clearfix"></div>
				</div>
			</div>
