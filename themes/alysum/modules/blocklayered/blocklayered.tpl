		...
		<form action="#" id="layered_form">
			<div>
				...
				<div id="enabled_filters">
					<span class="layered_subtitle lmromancaps" style="float: none;">{l s='Enabled filters:' mod='blocklayered'}</span>
					<ul>
				...
				{foreach from=$filters item=filter}
					{if isset($filter.values)}
						...
						<div>
						{/if}
						<span class="layered_subtitle lmromancaps">{$filter.name|escape:html:'UTF-8'}</span>
