...
class Mail extends MailCore
{
	...
	public static function getOptions()	{  // get options from database
		if (!$sett = Db::getInstance()->ExecuteS('SELECT * FROM `'._DB_PREFIX_.'pk_theme_settings`')) return false;
		...
		$template_path = _PS_MAIL_DIR_, $die = false, $id_shop = null, $bcc = null)
	{
		...
		try {
			...
			// ALYUMS SETTINGS
			$emailSettings = Mail::getOptions(); // get email settings from database
			$template_vars['{advert_link}'] = $emailSettings["email_adv_link"];
			$template_vars['{sn_facebook}'] = $emailSettings["email_fb_acc"];
...
//			$template_vars['{email_addr}'] = $emailSettings["email_addr_text"];		
			...
			$template_vars['{social_networks}'] = '<p style="line-height:29px; color:#505050; font-size:13px"><a href="http://www.facebook.com/ModicaBeauty" style="color:#505050;">Facebook</a><br/><a href="http://twitter.com/Modica_Beauty" style="color:#505050;">Twitter</a><br/><a href="http://plus.google.com/u/0/114216189760484036393/posts" style="color:#505050;">Google Plus</a><br/><a href="http://www.youtube.com/channel/UCDGMDR_bgrWqWvYCYz70tGg" style="color:#505050;">YouTube</a><br/><a href="http://instagram.com/modicabeauty" style="color:#505050;">Instagram</a><br/><a href="http://uk.pinterest.com/modicabeauty/" style="color:#505050;">Pinterest</a></p>';		
			...
			if ($emailSettings["email_adv"]) {
				...
				$template_vars['{adv_img}'] = "";
			}

			// END OF ALYSUM SETTINGS
