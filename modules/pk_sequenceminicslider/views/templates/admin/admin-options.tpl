...
<fieldset id="option" class="hidden-div">
	<legend>{l s='Options' mod='pk_sequenceminicslider'}</legend>
		...
		<div id="options" class="container">
            ...
            <div class="slice">
                ...
                <div>
				    ...
				    <input type="text" name="slices" value="{$slider.options.slices}" class="tooltip2" title="{l s='The number of Slices for Slice animation'}">
				</div>
                <div>
                    <label>{l s='BoxCols'}: </label>
				    <input type="text" name="cols" value="{$slider.options.cols}" class="tooltip2" title="{l s='The number of Cols for Box animations'}">
			    </div>
                <div>
                	<label>{l s='BoxRows'}: </label>
			        <input type="text" name="rows" value="{$slider.options.rows}" class="tooltip2" title="{l s='The number of Rows for Box animations'}">
			    </div>
            </div>-->
            <div class="configuration">
                <h3>{l s='Animation Configuration' mod='pk_sequenceminicslider'}</h3>
                <!--<div>
                    <label>{l s='Speed'}: </label>
					<input type="text" name="speed" value="{$slider.options.speed}" class="tooltip2" title="{l s='Slide transition speed in miliseconds (default is 0.5 sec)'}">                    
                </div>    -->
                <div>
                    <label>{l s='Pause Time' mod='pk_sequenceminicslider'}: </label>
					<input type="text" name="pause" value="{$slider.options.pause}" class="tooltip2" title="{l s='How long each slide will be shown in miliseconds (default is 3 sec)' mod='pk_sequenceminicslider'}">
                </div>
                <div class="switch">
                    <label>{l s='Pause on Mouse Hover' mod='pk_sequenceminicslider'}: </label>
					...
					<span class="info_ico tooltip2" title="{l s='Pause the slider on mouse hover.' mod='pk_sequenceminicslider'}"></span>
                </div>
                <div class="switch">
                    <label>{l s='Auto Rotate' mod='pk_sequenceminicslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='Turn it OFF if you dont want the slider to auto slide.' mod='pk_sequenceminicslider'}"></span>
                </div>                    
            </div>
            <div class="navigation">
                <h3>{l s='Navigation' mod='pk_sequenceminicslider'}</h3>
                <div class="switch">
                    <label>{l s='Prev/Next button' mod='pk_sequenceminicslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='If you want previous and next buttons on the two side of the slider, then turn this on.' mod='pk_sequenceminicslider'}"></span>
                </div>
                <div class="switch">
                    <label>{l s='Control' mod='pk_sequenceminicslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='This controls the navigation, by default these are the litle dots under the slider.' mod='pk_sequenceminicslider'}"></span>
                </div>
               <!-- <div class="switch">
            ...
            <div class="other">
                <h3>{l s='Other' mod='pk_sequenceminicslider'}</h3>
                <!--<div class="switch">
                ...
                <div>
					...
					<input type="text" name="startSlide" value="{$slider.options.startSlide}" class="tooltip2" title="{l s='The starting slide, begining with 0. So if you have 5 slides and you want to start with the last slide than you write 4.'}">
                </div> -->
                <div class="switch">
                    <label>{l s='I need multilanguage' mod='pk_sequenceminicslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='Turn on if you want to use different slides for different languages, otherwise the default language slides will be used for all the languages.' mod='pk_sequenceminicslider'}"></span>
                </div>       
                <!--<div>
                	<label>{l s='Slider width'}: </label>
					<input type="text" name="width" value="{$slider.options.width}" class="tooltip2" title="{l s='If you want to fix the width of the slider than fill this out.'}">
				</div>
				<div>
					<label>{l s='Slider height'}: </label>
					<input type="text" name="height" value="{$slider.options.height}" class="tooltip2" title="{l s='If you want to fix the height of the slider than fill this out.'}">
                </div>             
                <div class="switch">
            ...
            <div class="button_cont">
				<input type="submit" name="submitOptions" value="{l s='Update' mod='pk_sequenceminicslider'}" id="submitOptions" class="green large" />
			</div>
		</div>
	</form>
</fieldset>