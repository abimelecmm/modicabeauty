...
class ph_simpleblog extends Module
{
    ...
    public function prepareModuleSettings()
    {
        ...
        Configuration::updateValue('PH_BLOG_THUMB_X', '717');
        Configuration::updateValue('PH_BLOG_THUMB_Y', '423');
        Configuration::updateValue('PH_BLOG_THUMB_X_WIDE', '717');
        Configuration::updateValue('PH_BLOG_THUMB_Y_WIDE', '423');
        ...
        Configuration::updateValue('PH_CATEGORY_IMAGE_X', '717');
