...
<?php
 ...
 // echo $query."<br>";
  ...
  echo '<th><a href="" onclick="this.blur(); return sortTable(\'offTblBdy\', \'0\', false);" title="keywords">keywords</a></th>';
  ...
  { 
    echo '<tr>';
    echo '<td srt="'.str_replace('"','\\"',trim(strtolower($datarow["keywords"]))).'"><a href onclick="return showdetails(this);">'.$datarow["keywords"].'</a></td>';
