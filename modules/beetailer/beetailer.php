...
class Beetailer extends Module{
  ...
  public function __construct(){
	...
	public function install(){
		if (!parent::install() OR !$this->registerHook('orderConfirmation') OR !$this->registerHook('footer') OR !$this->registerHook('displayBackOfficeHeader'))
			return false;
  ...
  public function getCategoryTree(){
    $this->loadEnv();
    return (Category::getRootCategory($_GET["id_lang"])->recurseLiteCategTree(3, 0, $_GET['id_lang']));
  }
  
  /* Products */
  public function getProducts(){
    $this->loadEnv();
    return (ProductExtended::getProducts($_GET['id_category'], NULL, $_GET['id_lang'], $_GET['page'], $_GET['limit'], NULL, NULL, NULL, NULL, NULL, NULL, $_GET['extended'], $_GET['id_country']));
  }

  public function getProduct(){
    $this->loadEnv();
    return (ProductExtended::getProducts(NULL, $_GET['id_product'], $_GET['id_lang'], NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, $_GET['id_country']));
  }

  public function getTotal(){
    return (ProductExtended::getProducts($_GET['id_category'], NULL, $_GET['id_lang'], NULL, NULL, NULL, NULL, true, NULL));
  }
  ...
  public function getCountries() {
    return Country::getCountries($_GET['id_lang'], true, false, false);
  }
  ...
  public function getModuleVersion(){
    return array('module_version' => $this->version, 'installed' => $this->isInstalled('Beetailer'), 'ps_version' => _PS_VERSION_,
      'auth_valid' => $_GET['auth_key'] && $this->isKeyActive($_GET['auth_key']) ? true : false);
  }
...
if(isset($_GET['method'])){
  if($_GET['method'] != 'getModuleVersion' && !$beetailer->isKeyActive($_GET['auth_key'])){
