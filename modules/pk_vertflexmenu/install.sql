CREATE TABLE IF NOT EXISTS `PREFIX_pk_vertflexmenu_menus` (
`id_pk_vertflexmenu_menus` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `PREFIX_pk_vertflexmenu_submenus` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_pk_vertflexmenu_menus_lang` (
`id_pk_vertflexmenu_menus` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
`id_lang` INT NOT NULL,
`id_shop` INT NOT NULL,
`label` VARCHAR( 128 ) NOT NULL,
INDEX ( `id_pk_vertflexmenu_menus`, `id_shop`)
) ENGINE = ENGINE_TYPE CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE TABLE IF NOT EXISTS `PREFIX_pk_vertflexmenu_links` (
`id_pk_vertflexmenu_links` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
`id_shop` INT UNSIGNED NOT NULL,
`new_window` TINYINT( 1 ) NOT NULL,
INDEX (`id_shop`)
) ENGINE = ENGINE_TYPE CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE TABLE IF NOT EXISTS `PREFIX_pk_vertflexmenu_links_lang` (
`id_pk_vertflexmenu_links` INT NOT NULL,
`id_lang` INT NOT NULL,
`id_shop` INT NOT NULL,
`label` VARCHAR( 128 ) NOT NULL ,
`link` VARCHAR( 128 ) NOT NULL ,
INDEX ( `id_pk_vertflexmenu_links` , `id_lang`, `id_shop`)
) ENGINE = ENGINE_TYPE CHARACTER SET utf8 COLLATE utf8_general_ci;
INSERT INTO `PREFIX_pk_vertflexmenu_menus` VALUES(1, 1, 1, 1, 0, '');
INSERT INTO `PREFIX_pk_vertflexmenu_menus_lang` VALUES(1, 1, 1, 'CAT2');
INSERT INTO `PREFIX_pk_vertflexmenu_submenus` VALUES(1, 'IMAGE', '', '', '', '', '', '', 0, 'LINKS', '', 'CMS1,CMS2,CMS4,CMS5', '', '', 1, 'IMAGE', '', '', '', '', '', '', 0, 0, '', 'LINKS', '', '', '', '', '', 0);