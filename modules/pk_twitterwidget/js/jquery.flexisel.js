    ...
    $.fn.flexisel = function(options) {	    
	    ...
	    *******************************/
            appendHTML : function() {
                ...
                $("<div class='"+pref+"-flexisel-left flexisel-nav nbs-flexisel-nav-left'></div><div class='"+pref+"-flexisel-right flexisel-nav nbs-flexisel-nav-right'></div>").insertAfter('.'+pref+'-nbs-flexisel-container');
                if (settings.clone) {
