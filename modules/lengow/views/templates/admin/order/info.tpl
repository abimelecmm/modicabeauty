...
<fieldset>
	...
	<div class"button-command-prev-next">
		<button id="reimport-order" class="button" data-url="{$action_reimport|escape:'htmlall':'UTF-8'}" data-orderid="{$order_id|escape:'htmlall':'UTF-8'}" data-lengoworderid="{$id_order_lengow|escape:'htmlall':'UTF-8'}" data-feedid="{$id_flux|escape:'htmlall':'UTF-8'}" data-version="{$version|escape:'htmlall':'UTF-8'}">{l s='Cancel and re-import order' mod='lengow'}</button>
