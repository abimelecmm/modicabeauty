$(document).ready(function() {  
    $(".registered #productsCarousel_bottom .product_like a").live('click', function() {
        ...
        success: function(result){                
          if (result == '0')
          {
            ...
            if (fav_url == favorite_products_url_add) {
                $("#productsCarousel_bottom").find("[data-productid='" + fav_pid + "'] .product_like").addClass("active");
                ...
                $("#productsCarousel_bottom").find("[data-productid='" + fav_pid + "'] .product_like").removeClass("active");
                $(".favQty").text(num-1);
                var pName = $(".p"+fav_pid).attr("title");
                if (!!$.prototype.fancybox)
                    $.fancybox.open([
