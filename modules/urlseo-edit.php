...
{ var tmp;
  ...
  { tab = document.getElementById('Maintable');
    ...
    field = tab.rows[1].cells[fieldno].children[0].innerHTML;
...
function str2url(str)
{
	...
	str = str.replace(/\&amp\;/," <?php echo $and_code; ?> "); /* added */
...
//id_meta  id_lang 	name 	description 	link_rewrite 	meta_title 	meta_keywords 	meta_description
  ...
  $query="select l.*,m.page from ". _DB_PREFIX_."meta m";
  $query .= " LEFT JOIN ". _DB_PREFIX_."meta_lang l on l.id_lang='".mysqli_real_escape_string($conn, $id_lang)."' AND m.id_meta=l.id_meta AND l.id_shop='".$id_shop."'";
