                              ...
                              <form id="{$iso}_{$slide.id_order}" method="post" action="{$slider.postAction}" enctype="multipart/form-data">
                                  ...
                                  <div class="form_cont">
                                      <div class="title input">
                                          ...
                                          <input type="text" name="title" class="tooltip2" size="41" value="{$slide.title}" title="{l s='This will be the title on the slide.'}" /> 
                                      </div>
                                      <div class="url input">
                                      	<label>{l s='Url'}: </label>
                                      	<input type="text" name="url" class="tooltip2" size="41" value="{$slide.url}" title="{l s='ex. http://myshop.com/promotions'}" />           
                                      </div>
                                      <div class="target">
                                          <label>{l s='Blank target'}: </label>
                                          <input type="checkbox" name="target" class="tooltip2" value="1" {if $slide.target == 1}checked="true"{/if} title="{l s='Check this if you want to open the link in new window.'}" />
                                      </div>
                                      <div class="alt input">
                                          <label>{l s='Image alt'}: </label>
                                          <input type="text" name="alt" class="tooltip2" size="41" value="{$slide.alt}" title="{l s='The image alt, alternate text for the image'}" />
                                      </div>
